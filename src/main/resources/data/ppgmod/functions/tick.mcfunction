...
execute as @a[scores={clearall=1..}] run title @a title "§4ВСЕ ENTITY УБИТЫ!"
...
execute as @a[scores={clear=1..}] run title @a title "§6Карта очищена!"
...
execute as @a[scores={set_unbreakable=1..}] run title @s title "§3Предмет неломаем"
